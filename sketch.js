...
function setup() {
  ...
  // ipod = new Draggable(windowWidth/2+100, windowHeight/2, 100, 100, ipod_img);
}
...
function show_text_1(){
  ...
  textSize(24);
  strokeWeight(1); 
  text('I purchased it back in 2009 when I was 13. When I left my family for a boarding school far away from home and suffered from insomnia and loneliness at night, the world of music that my Nano drew me into comforted me and accompanied my whole teenage life. With hundreds of songs stored in its tiny body, my Nano was one of my most supportive and loyal friends in those tough coming of age days. Today, as a creative technologist, I am excited to apply for the Web Developer role within the Orchard program at Apple.',100,300,600,600);
}
...
function show_text_3(){
  ...
  text('👯‍♀️ is energized from collaborative work via clear communication',100,350,800,50);
